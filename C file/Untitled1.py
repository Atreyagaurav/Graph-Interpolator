...
try:
    ...
    while True:
        ...
        if(1030<pt.x<1270 and 455<pt.y<485):
            ...
            fprev.close()
            xep=Exep.getText()
            system("inter"+" "+xep+" "+"form.txt"+" "+str(n))
        ...
        if(1030<pt.x<1270 and 350<pt.y<380):
            ...
            if abs((pix_XX-pix_OX)*(pix_YX-pix_OX)+(pix_XY-pix_OY)*(pix_YY-pix_OY))<(1+(1-accuracy)*5):
                ...
                t=2
                det=pix_OX*pix_XY-pix_XX*pix_OY-pix_OX*pix_YY+pix_YX*pix_OY+pix_XX*pix_YY-pix_YX*pix_XY
                alpha1=(pix_XX*pix_YY-pix_YX*pix_XY)*ord_OX+(-pix_OX*pix_YY+pix_YX*pix_OY)*ord_XX+(pix_OX*pix_XY-pix_XX*pix_OY)*ord_YX
                alpha2=(pix_XY-pix_YY)*ord_OX+(pix_YY-pix_OY)*ord_XX+(pix_OY-pix_XY)*ord_YX
                alpha3=(pix_YX-pix_XX)*ord_OX+(pix_OX-pix_YX)*ord_XX+(pix_XX-pix_OX)*ord_YX
                alpha4=(pix_XX*pix_YY-pix_YX*pix_XY)*ord_OY+(-pix_OX*pix_YY+pix_YX*pix_OY)*ord_XY+(pix_OX*pix_XY-pix_XX*pix_OY)*ord_YY
                alpha5=(pix_XY-pix_YY)*ord_OY+(pix_YY-pix_OY)*ord_XY+(pix_OY-pix_XY)*ord_YY
                alpha6=(pix_YX-pix_XX)*ord_OY+(pix_OX-pix_YX)*ord_XY+(pix_XX-pix_OX)*ord_YY
            ...
            while True:
                ...
                if t==0:
                    ...
                    iptx[n]=alpha1+alpha2*pt.x+alpha3*pt.y
                    ipty[n]=alpha4+alpha5*pt.x+alpha6*pt.y
                x=pt.x
                y=pt.y
                if(n==0):
                    xi=x
